 ...
 * @param {boolean} opts.usePromises Whether to use promises instead of callbacks.
...
function BaseAPIClient(token, opts) {
  ...
  /** @type {boolean} */
  this.usePromises = opts.usePromises || false;
...
BaseAPIClient.prototype.makeAPICall = function makeAPICall(endpoint, optData, optCb) {
  ...
  if (this.usePromises && apiCallArgs.cb !== noop) {
    this.logger('warn', 'callback passed for client in usePromises mode, callback will be ignored');
  }
